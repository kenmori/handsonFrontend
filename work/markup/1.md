...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-3.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-1.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-2-1.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-3-1.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-4.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-5.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-6.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-7.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-8.png" width="50px" >

async awaitを使って同じことをやってください。rejectは考慮しないでいいです。問題7をasync awaitを使って書いてください

### 10

<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-9.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-10.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-11.png" width="50px" >

クリックしたらリクエストをして、それらが表示されるようにしてください

### 13

<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-12.png" width="50px" >

クリックしたらモーダルが出てきて、12で作ったボタンを押したらリクエストされ表示するようにしてください

### 14

<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-13.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-14.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-15.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-16.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-17.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-18.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-19.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-20.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-22.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-23.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-24.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-25.png" width="50px" >
...
<img src="https://terracetech.jp/wp-content/uploads/2021/04/無題215-26.png" width="50px" >
...
其の返値に trueか false が返ってきてbool値に応じて画面ページか失敗しましたページ。

成功したらその後、コンテンツ画面ページ側で
該当トークンをlocalstorageに埋め込んでください。

以後はまたログインページに遷移したらトークンがある場合コンテンツページに遷移するはずで
ローカルストレージを削除したらログイン画面そのまま映し出す。
...
### 4.1づつupされるカウンターを作ってください

<img src="https://kenjimorita.jp/wp-content/uploads/2021/03/もりけんじゅく-P6.png" width="300">

[仕様]
- 親に存在するボタンをclickすると親に存在する表示箇所で1,2,3とインクリメンタルする

### 5.インクリメンタルしていく値が3の倍数の時、1増える表示を作ってください
<img src="https://kenjimorita.jp/wp-content/uploads/2021/03/もりけんじゅく-P7.png" width="300">

[仕様]
- 親に存在するボタンをclickすると親に存在する表示箇所Aで1,2,3とインクリメンタルする
- 3倍になると1増える表示箇所Bがある


### 6.インクリメンタルしていく値が3の倍数の時、子供で1増える表示を作ってください

[仕様]
- 親に存在するボタンをclickすると親に存在する表示箇所Aで1,2,3とインクリメンタルする
- 3倍になると子供で1増える表示箇所Bがある

<img src="https://kenjimorita.jp/wp-content/uploads/2021/03/もりけんじゅく-P8.png" width="300">

### 7.子供でインクリメンタルしていく値が3の倍数の時、親で1増える表示を作ってください

[仕様]
- 子供に存在するボタンをclickすると子供に存在する表示箇所Aで1,2,3とインクリメンタルする
- 子供で3の倍数になると親で1増える表示箇所Bがある

<img src="https://kenjimorita.jp/wp-content/uploads/2021/03/もりけんじゅく-P9.png" width="300">

### 8.子供でインクリメンタルしていく値が3の倍数の時、親で1増える表示Bと孫で1増える表示Cを作ってください
...
- 子供に存在するボタンをclickすると子供に存在する表示箇所Aで1,2,3とインクリメンタルする
- 子供で3の倍数になると親で1増える表示箇所Bがある
- 子供で3の倍数になると孫で1増える表示箇所Cがある


### 9. 親でインクリメンタルしていく値が3の倍数の時、子供で1増える表示Bと、孫で持つボタンをクリックすると子供の値と親の値が0になるもの作ってください

<img src="https://kenjimorita.jp/wp-content/uploads/2021/03/もりけんじゅく-P11.png" width="300">

[仕様]
- 親に存在するボタンをclickすると親の表示箇所Aで1,2,3とインクリメンタルする
- 親の値が3の倍数になると子供で1増える表示箇所Bがある
- 孫が持つボタン押下すると親、子供に持つ値は0になる

### 10. 親でインクリメンタルしていく値が3の倍数の時、子供で1増える表示Bと、子供の兄弟要素として1増える表示B-2、孫で持つボタンをクリックすると子供の値と親の値が0になるもの作ってください
...
- 親に存在するボタンをclickすると親の表示箇所Aで1,2,3とインクリメンタルする
- 親の値が3の倍数になると子供で1増える表示箇所Bがある
- 親の値が3の倍数になると子供2で1増える表示箇所B-2がある
- 孫が持つボタン押下すると親、子供に持つ値は0になる

### 11. 親でインクリメンタルしていく値が3の倍数の時、子供で1増える表示Bと、子供の兄弟要素として表示B-2はレンダーしない、孫で持つボタンをクリックすると子供の値と親の値が0になるもの作ってください


<img src="https://kenjimorita.jp/wp-content/uploads/2021/03/もりけんじゅく-P13.png" width="300">


### 12. useEffectとsetStateを使って、配列をマウント時にstate値として更新し、子供で#5と同じ表示を作ってください
...
auth[https://dev.to/ruanmartinelli/authentication-with-supabase-and-react-32h4]